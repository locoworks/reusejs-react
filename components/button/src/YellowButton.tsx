...
const YellowButton: FC<YellowButtonProps> = (props) => {
  const defaultStyleClasses =
    "inline-flex justify-center items-center focus:outline-none font-normal text-sm bg-yellow-400 hover:bg-yellow-700 text-white rounded-md px-4 py-2 border border-transparent";

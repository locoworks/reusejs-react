...
- **slides** (required) :  An array of React elements representing the individual slides to be displayed in the carousel.
...
- `slides` (React.ReactNode[]): An array of Reactelements representing the slides to be displayed.
...
- `previousButton` (React.ReactNode): Custom Reactelement to be used as the previous button to back on the previous slide.
- `nextButton` (React.ReactNode): Custom Reactelement to be used as the next button to go to the next slide.
...
- `statusArray`: An array of React elements representing the statuses or slides to be displayed in the slider.
...
- `footer` (optional): React element representing the content to be displayed below each slide.
...
- `nextButton` (optional): React element representing the content of the next button. It will be displayed on the right side of the slider.

- `prevButton` (optional): React element representing the content of the previous button. It will be displayed on the left side of the slider.

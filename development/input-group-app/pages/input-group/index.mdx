...
import ForwardRefInputGroup from "../../components/input-group/ForwardRefInputGroup/ForwardRefInputGroup.tsx"
import MultipleInput from "../../components/input-group/MultipleInput/MultipleInput.tsx"
import DropdownInputGroup from "../../components/input-group/DropdownInputGroup/DropdownInputGroup.tsx"
import SizeInputGroup from "../../components/input-group/SizeInputGroup/SizeInputGroup.tsx"
import BetaFormSample from "../../components/input-group/BetaFormSample/BetaFormSample.tsx"

## ReuseJS Input-Group Component
...
To use the `HeadlessInputGroup` component, install it in your project:

```bash
npm install @locoworks/reusejs-react-input-group
or 
yarn add @locoworks/reusejs-react-input-group
```

## Importing

Import the `HeadlessInputGroup` component and necessary enums:
...
<ForwardRefInputGroup/>

```js path=../../components/input-group/ForwardRefInputGroup name=ForwardRefInputGroup
```
...
```js path=../../components/input-group/MultipleInput name=MultipleInput
```
...
```js path=../../components/input-group/DropdownInputGroup name=DropdownInputGroup
```
...
```js path=../../components/input-group/SizeInputGroup name=SizeInputGroup
```

### BetaForm Sample

This example show a use-case of how to use input group with `BetaForm` to handle error and validation using validate.js.
...
```js path=../../components/input-group/BetaFormSample name=BetaFormSample
```

## Styling

Styling the `ReuseInputGroup` component can be done using Tailwind CSS or custom CSS.

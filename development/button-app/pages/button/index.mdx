...
This Button Showcase page serves as a visual reference and demonstration of different button styles and configurations available for use in your application. It aims to provide inspiration and guidance in selecting and implementing buttons that align with your design requirements and user experience goals.
...
The Success Sample Button is a customizable button that provides feedback to the user by showing a **loading** state for a specified duration and then disabling the button and displaying a **success** state. The **success** state and the **busy** state along with the **duration** can be customised as per the requirement.
<SuccessSample/>
...
## CSSStyledButton
This code snippet of the button will give you a customizable button with CSS Styling. We have declared a styles object having CSS properties which can be passed as a prop to our HeadlessButton component to give it the style we need. You can customize the styles object according to your requirements.
<CSSStyledButton/>
...
## Icon Button
This is a simpe icon button. In the code snippet we have given it a sample right arrow image. You can give it any image you want as per your requirements.
<IconButton/>
...
## Live Playground
Below is an editable code snippet. You can try to create the perfect button for you and give it any style to suit your requirements.
<LiveSample/>

...
## ReuseJS Button Component

## Overview

This Button component serves as a visual reference and demonstration of different button styles and configurations available for use in your application. It aims to provide inspiration and guidance in selecting and implementing buttons that align with your design requirements and user experience goals.
...
To use the `Button` component, install it in your project:

```bash
npm install @locoworks/reusejs-react-button
or 
yarn add @locoworks/reusejs-react-button
```

## Importing

Import the `HeadlessButton` component and necessary enums:
...
The following components are available from the `@locoworks/reusejs-react-button` package:

- `HeadlessButton`: The button component with no inherent styles.
- `ReuseButton`: The button component with sample styles included.
...
Styling the `HeadlessButton` component and `ReuseButton` component can be done using Tailwind CSS or custom CSS.

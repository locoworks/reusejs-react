...
import CustomDatePicker from "../../components/date-picker/CustomDatePicker/CustomDatePicker.tsx"
...
<CustomDatePicker/>
```js path=../../components/date-picker/CustomDatePicker name=CustomDatePicker
```

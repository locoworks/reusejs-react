...
## Props
The `HeadlessModal` component does not take any props itself. However, the modal component created using this hook will receive props based on the configuration provided through the `config` object.

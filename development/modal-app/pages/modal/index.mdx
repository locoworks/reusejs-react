...
import DisabledOutsideClick from "../../components/modal/DisabledOutsideClick/DisabledOutsideClick.tsx"
...
```js path=../../components/modal/DisabledOutsideClick name=DisabledOutsideClick
```

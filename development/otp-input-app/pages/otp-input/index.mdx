...
#### Email Verification
We have made a email verification component using ReuseOTPInput. We have already made the email state for you. Just give your email state and add the functionality to this component and you can use it in your application.
<EmailVerification/>

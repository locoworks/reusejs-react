...
#### Email Verification
We have made a email verification component using ReuseOTPInput.Just give email and add the functionality to this component and you can use it in your application.
<EmailVerification/>

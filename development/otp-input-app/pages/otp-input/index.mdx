...
## ReuseJS OtpInput Component

## Overview

The `HeadlessOtpInput ` and `ReuseOtpInput` component facilitates the handling of One-Time Password (OTP) input fields within your React applications. Designed with simplicity and efficiency in mind, this component empowers developers to seamlessly integrate OTP input functionality, enhancing user authentication processes.

## Installation

To use the `HeadlessOtpInput` or `ReuseOtpInput` component, install it in your project:

```bash
npm install @locoworks/reusejs-react-otp-input
or 
yarn add @locoworks/reusejs-react-otp-input
```

## Importing

To use HeadlessOtpInput in your project, install it in your project
```jsx
import { HeadlessOtpInput } from "@locoworks/reusejs-react-otp-input";
```
or

To use ReuseOTPInput in your project, install it in your project
```jsx
...
## Styling
Styling the `HeadlessOtpInput` component can be done by passing Tailwind CSS or custom CSS to the props:

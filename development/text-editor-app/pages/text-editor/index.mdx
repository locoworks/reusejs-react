...
- `onEditorRefChange`: An optional callback for editor reference changes.
...
- Handle editor reference changes using the onEditorRefChange prop.
...
| `onEditorRefChange`       | `(editorRef: LexicalEditor \| null) => void`                       | Optional callback for editor reference changes.                                                                                     |

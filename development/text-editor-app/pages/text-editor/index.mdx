...
- `mentionsData`: An array of objects representing mentions data.
...
| --------------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------- |
| `mentionsData	` | `Array<{ mentionName: string; label: string; }>`                             | An array of objects representing mentions data. Each object should have mentionName and label properties.                                                           |
